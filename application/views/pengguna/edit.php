        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Perbaharui Pengguna</h6>
                </div>
            </div>
            <form method="POST" action="<?= base_url('pengguna/edit/' . $data->id_user) ?>" enctype="multipart/form-data">
                <div class="card-body">
                    <?php
                    // Validasi error                    
