        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <?php if ($data->void_pesanan) : ?>
                        <div class="col-md-12 mb-2">
                            <label>Alasan Void</label>
                            <div class="form-control free-form">
                                <?= $data->alasan_void_pesanan ?>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="card-footer text-right">
                <a href="<?php echo base_url('laporanpesanan') ?>" class="btn btn-secondary btn-icon-split btn-sm">
