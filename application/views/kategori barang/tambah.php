...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            ...
            <form method="POST" action="<?= base_url('kategoribarang/tambah') ?>">
                <div class="card-body">
                    <?php
                    // Validasi error
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="text" class="form-control" name="nama_kategori_barang" required value="<?= set_value('nama_kategori_barang') ?>">
                        </div>                        
                    </div>
                </div>
